...
while(select ~= STOP)
    ...
    select = menu('Seleccione:', 'Cinemática Directa & Plot do Robot',...
                                 'Velocidades das juntas',...
                                 'Malha de controlo',...
                                 'Sair');  
                                                
   % Matriz dos parÃ¢metros de Denavith-Hartenberg: PJ_DH e a O T G
    if first < 1
        disp('______________________________________________________________________')
        disp(' ')
        disp('Matriz dos parÃ¢metros de Denavith-Hartenberg: PJ_DH')
        disp('______________________________________________________________________')
        disp(' ')
        robot.display
        disp('______________________________________________________________________')
...
%                        1, 'scale', 10, 'zoom', 0.25, 'view', 'top', 'jaxes');
    ...
    if select == 2        
        ...
        disp('______________________________________________________________________')
        disp(' ')
        disp('ExpressÃµes para a velocidade das juntas c/ Wz = pi rad/s')
        disp(' ')
        disp(qVelocidades)
    ...
    if select == 3
       ...
       while(select2 ~= STOP2)
           ...
           if select2 == 2
               ...
               % Controlo Propocional kp > 0.65 InstavÃ©l 
               kp = 0.25;
